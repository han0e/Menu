...
export default function InspirationGallery({
  ...
  useEffect(() => {
    async function fetchAllImages() {
      ...
      if (designerId) {
        targetFolders = [{ name: designerId }];
      } else {
        // 1. Get all folders (fallback if no session)
        ...
        targetFolders = folders.filter(
          (f) => !f.name.includes(".") && f.name !== ".emptyFolderPlaceholder",
        );
      }
            ...
            {galleryData.map((item, idx) => (
              <div
                ...
                style={{
                  position: "relative",
                  width: "100%",
                  marginBottom: columns === 1 ? "16px" : "8px",
                  breakInside: "avoid",
                  cursor: "pointer",
                  overflow: "hidden",
                  background: "var(--surface-2)",
                  borderRadius: columns === 1 ? "12px" : "8px",
      ...
      >
        {selectedIndex === null && (
          <div
            style={{
              padding: "16px",
              borderBottom: "1px solid var(--bdr-lo)",
              display: "flex",
        ...
        <div
          style={{
            ...
            overflowY: "auto",
            overflowX: "hidden",
            background: selectedIndex !== null ? "#000" : "var(--bg)",
          }}
        >
